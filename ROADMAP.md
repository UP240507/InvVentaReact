...
| ----------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Impresión en papel**              | Nunca ha salido un ticket de una impresora física. Todo está verificado contra `previsualizar`, que es el renderizador real, pero faltan la tabla de caracteres, el corte y **el ancho**: la TM-T20II es de 80 mm y `ANCHO` está fijado a 32 (58 mm). Hay que hacerlo configurable. | **Alto** — es el bloqueante operativo de la fase y hay trabajo derivado seguro.                                                                                                                      |
| **3.12 Shell desktop**              | El empaquetado NSIS **ya está configurado**; falta generarlo y probarlo, el auto-updater (sin plugin ni endpoint) y la **firma de código**.                                                                                                                                         | **Alto** — la firma tiene plazo de calendario ajeno: es lo único que no depende de nosotros.                                                                                                         |
...
| 3.12 | Shell desktop                     | **🔨 PARCIAL (verificado 6-ago).** Lo que **sí** está: `tauri.conf.json` ya trae el empaquetado configurado —target **NSIS**, instalador en español, `installMode: currentUser`, iconos y `dist` como recurso—, así que `tauri build` debería producir un instalador hoy mismo. Lo que **falta**: (a) **generarlo y probarlo**, que nunca se ha hecho; (b) el **auto-updater** — `plugins` está vacío, no hay `tauri-plugin-updater` ni endpoint de versiones; (c) la **firma de código**, que no es trabajo sino trámite: sin ella SmartScreen avisa al instalar, y el certificado cuesta y tarda en emitirse. **Conviene arrancar el trámite del certificado antes que el código**: es lo único de todo el roadmap con plazo de calendario ajeno.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
