...
export default function ModificadoresScreen() {
  ...
  // El del creador de grupos cierra con `cerrarModal`, que además olvida qué
  // grupo se estaba editando. Los `useCierreConEscape` van DESPUÉS de
  // declararlo: arriba serían un uso antes de la declaración.
  const cerrarModal = () => {
